    ...
    <div class="col-md-6">
        <div class="card shadow">
            <div class="card-body p-4">
                <h4 class="mb-4">Nueva clase</h4>

                <form method="POST" action="{{ route('monitor.crear') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="time" name="hora_inicio" class="form-control" required value="{{ old('hora_inicio') }}">
                        </div>
                        <div class="col mb-3">
                            <label class="form-label">Hora fin</label>
                            <input type="time" name="hora_fin" class="form-control" required value="{{ old('hora_fin') }}">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Aforo máximo</label>
                        <input type="number" name="aforo" class="form-control" min="1" required value="{{ old('aforo') }}">
